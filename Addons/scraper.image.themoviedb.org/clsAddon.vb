...
#Region "Fields"
    ...
    Private _setup_Movie As frmSettingsHolder_Image_Movie
    Private _setup_MovieSet As frmSettingsHolder_Image_MovieSet
    Private _setup_TV As frmSettingsHolder_Image_TV
    Private _TMDBAPI_Movie As New clsScraper
    Private _TMDBAPI_MovieSet As New clsScraper
    Private _TMDBAPI_TV As New clsScraper
...
#Region "Methods"
    ...
    Private Sub Handle_SetupScraperChanged_MovieSet(ByVal state As Boolean, ByVal difforder As Integer)
        ...
        RaiseEvent SetupScraperChanged_MovieSet(String.Concat(_Name, "_MovieSet"), state, difforder)
    End Sub
    ...
    Function InjectSetupScraper_Movie() As Containers.SettingsPanel Implements Interfaces.IAddon_Image_Scraper_Movie.InjectSetupScraper
        ...
        _setup_Movie = New frmSettingsHolder_Image_Movie
        LoadSettings_Movie()
        ...
        Spanel.UniqueSettingsPanelID = String.Concat(_Name, "_Movie")
        Spanel.Title = "TheMovieDb.org"
        Spanel.Order = 110
    ...
    Function InjectSetupScraper_MovieSet() As Containers.SettingsPanel Implements Interfaces.IAddon_Image_Scraper_Movieset.InjectSettingsPanel
        Dim Spanel As New Containers.SettingsPanel
        _setup_MovieSet = New frmSettingsHolder_Image_MovieSet
        LoadSettings_MovieSet()
        ...
        Spanel.UniqueSettingsPanelID = String.Concat(_Name, "_MovieSet")
        Spanel.Title = "TheMovieDb.org"
        Spanel.Order = 110
    ...
    Function InjectSetupScraper_TV() As Containers.SettingsPanel Implements Interfaces.IAddon_Image_Scraper_TV.InjectSettingsPanel
        Dim Spanel As New Containers.SettingsPanel
        _setup_TV = New frmSettingsHolder_Image_TV
        LoadSettings_TV()
        ...
        Spanel.UniqueSettingsPanelID = String.Concat(_Name, "_TV")
        Spanel.Title = "TheMovieDb.org"
        Spanel.Order = 110
    ...
    Sub LoadSettings_Movie()
        ...
        strPrivateAPIKey = Master.eAdvancedSettings.GetStringSetting("APIKey", String.Empty, Enums.ContentType.Movie)
    ...
    Sub LoadSettings_MovieSet()
        ...
        strPrivateAPIKey = Master.eAdvancedSettings.GetStringSetting("APIKey", String.Empty, Enums.ContentType.MovieSet)
        _SpecialSettings_MovieSet.ApiKey = If(String.IsNullOrEmpty(strPrivateAPIKey), _strAPIKey, strPrivateAPIKey)
    End Sub

    Sub LoadSettings_TV()
        ConfigModifier_TV.EpisodePoster = Master.eAdvancedSettings.GetBooleanSetting("DoEpisodePoster", True, , Enums.ContentType.TV)
        ...
        strPrivateAPIKey = Master.eAdvancedSettings.GetStringSetting("APIKey", String.Empty, Enums.ContentType.TV)
    ...
    Function Scraper_Movie(ByRef DBMovie As Database.DBElement, ByRef ImagesContainer As MediaContainers.SearchResultsContainer, ByVal ScrapeModifiers As Structures.ScrapeModifiers) As Interfaces.AddonResult Implements Interfaces.IAddon_Image_Scraper_Movie.Scraper
        ...
        If DBMovie.MainDetails.UniqueIDs.TMDbIdSpecified Then
            ...
            ImagesContainer = _TMDBAPI_Movie.GetImages_Movie_MovieSet(DBMovie.MainDetails.UniqueIDs.TMDbId, FilteredModifiers, Enums.ContentType.Movie)
        End If
