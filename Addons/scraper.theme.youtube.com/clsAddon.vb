...
#Region "Methods"
    ...
    Sub LoadSettings_Movie()
        _ConfigScrapeModifier_Movie.MainTheme = Master.eAdvancedSettings.GetBooleanSetting("DoTheme", True, , Enums.ContentType.Movie)
    End Sub

    Sub LoadSettings_TV()
        _ConfigScrapeModifier_TV.MainTheme = Master.eAdvancedSettings.GetBooleanSetting("DoTheme", True, , Enums.ContentType.TV)
    End Sub
