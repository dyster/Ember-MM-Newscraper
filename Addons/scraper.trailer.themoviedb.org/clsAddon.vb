...
#Region "Fields"
    ...
    Private _TMDBAPI As New Scraper
...
#Region "Methods"
    ...
    Sub LoadSettings()
        ...
        _SpecialSettings.FallBackEng = Master.eAdvancedSettings.GetBooleanSetting("FallBackEn", False)
        strPrivateAPIKey = Master.eAdvancedSettings.GetStringSetting("TMDBAPIKey", "")
    ...
    Sub SaveSettings()
        Using settings = New AdvancedSettings()
            settings.SetStringSetting("TMDBAPIKey", _setup.txtApiKey.Text)
