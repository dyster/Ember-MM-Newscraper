...
#Region "Methods"
            ...
            Select Case dbElement.ContentType
                Case Enums.ContentType.Movie, Enums.ContentType.TVEpisode
                    If dbElement.FilenameSpecified Then
                        While Not File.Exists(dbElement.Filename)
                            If showMessage Then
                ...
                Case Enums.ContentType.Movieset
                    For Each movie In dbElement.MoviesInSet
                        While Not File.Exists(movie.DBMovie.Filename)
                            If showMessage Then
                                Select Case MessageBox.Show(String.Concat(
                                                            Master.eLang.GetString(587, "This file is no longer available"), ".",
                                                            Environment.NewLine,
                                                            Master.eLang.GetString(630, "Reconnect the source and press Retry"), ".",
                                                            Environment.NewLine,
                                                            Environment.NewLine,
                                                            movie.DBMovie.Filename),
                                                            String.Empty,
        ...
        Public Shared Function GetAllItemsOfDBElement(ByVal tDBElement As Database.DBElement) As List(Of FileSystemInfo)
            ...
            Select Case tDBElement.ContentType
                        ...
                        Else
                            Select Case tDBElement.ContentType
                                Case Enums.ContentType.Movie
                                    ...
                                    lstFiles.AddRange(FileNames.Movie(tDBElement, Enums.ModifierType.MainBanner))
                                    lstFiles.AddRange(FileNames.Movie(tDBElement, Enums.ModifierType.MainClearArt))
                                    lstFiles.AddRange(FileNames.Movie(tDBElement, Enums.ModifierType.MainClearLogo))
                                    lstFiles.AddRange(FileNames.Movie(tDBElement, Enums.ModifierType.MainDiscArt))
                                    lstFiles.AddRange(FileNames.Movie(tDBElement, Enums.ModifierType.MainFanart))
                                    lstFiles.AddRange(FileNames.Movie(tDBElement, Enums.ModifierType.MainKeyart))
                                    lstFiles.AddRange(FileNames.Movie(tDBElement, Enums.ModifierType.MainLandscape))
                                    lstFiles.AddRange(FileNames.Movie(tDBElement, Enums.ModifierType.MainNFO))
                                    lstFiles.AddRange(FileNames.Movie(tDBElement, Enums.ModifierType.MainPoster))
                                    lstFiles.AddRange(FileNames.Movie(tDBElement, Enums.ModifierType.MainSubtitle))
                                    lstFiles.AddRange(FileNames.Movie(tDBElement, Enums.ModifierType.MainTheme))
                                    lstFiles.AddRange(FileNames.Movie(tDBElement, Enums.ModifierType.MainTrailer))
                                ...
                                Case Enums.ContentType.TVEpisode
                                    lstItems.Add(New FileInfo(tDBElement.Filename))
                                    Dim lstFiles As New List(Of String)
                                    lstFiles.AddRange(FileNames.TVEpisode(tDBElement, Enums.ModifierType.EpisodeFanart))
                                    lstFiles.AddRange(FileNames.TVEpisode(tDBElement, Enums.ModifierType.EpisodeNFO))
                                    lstFiles.AddRange(FileNames.TVEpisode(tDBElement, Enums.ModifierType.EpisodePoster))
                                    lstFiles.AddRange(FileNames.TVEpisode(tDBElement, Enums.ModifierType.EpisodeSubtitle))
                                    lstFiles.AddRange(FileNames.TVEpisode(tDBElement, Enums.ModifierType.EpisodeWatchedFile))
                                    lstFiles = lstFiles.Distinct().ToList()  'remove double entries
                                    lstFiles.Sort()
                                    For Each nFile In lstFiles
                                        Dim nFileinfo As New FileInfo(nFile)
                ...
                Case Enums.ContentType.Movieset
                    Dim lstFiles As New List(Of String)
                    lstFiles.AddRange(FileNames.Movieset(tDBElement, Enums.ModifierType.MainBanner))
                    lstFiles.AddRange(FileNames.Movieset(tDBElement, Enums.ModifierType.MainClearArt))
                    lstFiles.AddRange(FileNames.Movieset(tDBElement, Enums.ModifierType.MainClearLogo))
                    lstFiles.AddRange(FileNames.Movieset(tDBElement, Enums.ModifierType.MainDiscArt))
                    lstFiles.AddRange(FileNames.Movieset(tDBElement, Enums.ModifierType.MainFanart))
                    lstFiles.AddRange(FileNames.Movieset(tDBElement, Enums.ModifierType.MainKeyart))
                    lstFiles.AddRange(FileNames.Movieset(tDBElement, Enums.ModifierType.MainLandscape))
                    lstFiles.AddRange(FileNames.Movieset(tDBElement, Enums.ModifierType.MainNFO))
                    lstFiles.AddRange(FileNames.Movieset(tDBElement, Enums.ModifierType.MainPoster))
                    lstFiles = lstFiles.Distinct().ToList()  'remove double entries
                    lstFiles.Sort()
                    For Each nFile In lstFiles
                        Dim nFileinfo As New FileInfo(nFile)
                ...
                Case Enums.ContentType.TVSeason
                    ...
                    If tDBElement.MainDetails.Season_IsAllSeasons Then
                        lstFiles.AddRange(FileNames.TVShow(tDBElement, Enums.ModifierType.AllSeasonsBanner))
                        lstFiles.AddRange(FileNames.TVShow(tDBElement, Enums.ModifierType.AllSeasonsFanart))
                        lstFiles.AddRange(FileNames.TVShow(tDBElement, Enums.ModifierType.AllSeasonsLandscape))
                        lstFiles.AddRange(FileNames.TVShow(tDBElement, Enums.ModifierType.AllSeasonsPoster))
                        lstFiles = lstFiles.Distinct().ToList()  'remove double entries
                        lstFiles.Sort()
                    Else
                        lstFiles.AddRange(FileNames.TVSeason(tDBElement, Enums.ModifierType.SeasonBanner))
                        lstFiles.AddRange(FileNames.TVSeason(tDBElement, Enums.ModifierType.SeasonFanart))
                        lstFiles.AddRange(FileNames.TVSeason(tDBElement, Enums.ModifierType.SeasonLandscape))
                        lstFiles.AddRange(FileNames.TVSeason(tDBElement, Enums.ModifierType.SeasonNFO))
                        lstFiles.AddRange(FileNames.TVSeason(tDBElement, Enums.ModifierType.SeasonPoster))
                        lstFiles = lstFiles.Distinct().ToList()  'remove double entries
                        lstFiles.Sort()
                    End If
                    For Each nFile In lstFiles
        ...
        Public Shared Function IsValidDir(ByVal directory As DirectoryInfo, ByVal contentType As Enums.ContentType) As Boolean
            Try
                ...
                If (contentType = Enums.ContentType.Movie AndAlso directory.Name.ToLower = "extras") OrElse
                    ...
                    Return False
                End If
                For Each s As String In AdvancedSettings.AdvancedSettings.GetStringSetting("NotValidDirIs", ".actors|certificate|extrafanart|extrathumbs|audio_ts|recycler|subs|subtitles|.trashes").Split(New String() {"|"}, StringSplitOptions.RemoveEmptyEntries)
                    ...
                    End If
                Next
                For Each s As String In AdvancedSettings.AdvancedSettings.GetStringSetting("NotValidDirContains", "-trailer|[trailer|temporary files|(noscan)|$recycle.bin|lost+found|system volume information|sample").Split(New String() {"|"}, StringSplitOptions.RemoveEmptyEntries)
        ...
        Public Shared Function IsValidFile(ByVal file As FileInfo, ByVal contentType As Enums.ContentType) As Boolean
            Try
                ...
                If Not Master.eSettings.Options.FileSystem.ValidVideoExtensions.Contains(file.Extension.ToLower) Then
                    ...
                    Return False
                End If
                For Each s As String In AdvancedSettings.AdvancedSettings.GetStringSetting("NotValidFileContains", "trailer|sample").Split(New String() {"|"}, StringSplitOptions.RemoveEmptyEntries)
        ...
        Public Shared Function RemoveStackingMarkers(ByVal strPath As String) As String
            ...
            If Master.eAdvancedSettings.GetBooleanSetting("DisableMultiPartMedia", False) OrElse String.IsNullOrEmpty(strPath) Then Return strPath

            Dim FilePattern As String = Master.eAdvancedSettings.GetStringSetting("FileStacking", "(.*?)([ _.-]*(?:cd|dvd|p(?:ar)?t|dis[ck])[0-9]+)(.*?)(\.[^.]+)$")
            Dim FolderPattern As String = Master.eAdvancedSettings.GetStringSetting("FolderStacking", "((cd|dvd|dis[ck])[0-9]+)$")
...
#Region "Methods"
        ...
        Public Shared Function GetFileNames(ByVal dbElement As Database.DBElement, ByVal modifierType As Enums.ModifierType, Optional forced As Boolean = False) As List(Of String)
            Select Case dbElement.ContentType
                Case Enums.ContentType.Movie
                    Return Movie(dbElement, modifierType, forced)
                Case Enums.ContentType.Movieset
                    Return Movieset(dbElement, modifierType, forced)
                Case Enums.ContentType.TVEpisode
                    Return TVEpisode(dbElement, modifierType)
                Case Enums.ContentType.TVSeason
                    If dbElement.MainDetails.Season_IsAllSeasons Then
                        Return TVShow(dbElement, modifierType)
                    Else
                        Return TVSeason(dbElement, modifierType)
                    End If
                Case Enums.ContentType.TVShow
                    Return TVShow(dbElement, modifierType)
            End Select
        ...
        ''' <param name="forced">Enable ALL known file naming schemas. Should only be used to search files and not to save files!</param>
        ''' <returns><c>List(Of String)</c> all filenames with full path</returns>
        ''' <remarks></remarks>
        Public Shared Function Movie(ByVal dbMovie As Database.DBElement, ByVal modifierType As Enums.ModifierType, Optional ByVal forced As Boolean = False) As List(Of String)
            Dim FilenameList As New List(Of String)

            If String.IsNullOrEmpty(dbMovie.Filename) Then Return FilenameList

            Dim basePath As String = String.Empty
            Dim fPath As String = dbMovie.Filename
            ...
            Dim isSingle As Boolean = dbMovie.IsSingle
            ...
            Select Case modifierType
                Case Enums.ModifierType.MainActorThumbs
                    With Master.eSettings
                        If isVideoTS Then
                            If forced OrElse (.MovieUseFrodo AndAlso .MovieActorThumbsFrodo AndAlso Not .MovieXBMCProtectVTSBDMV) Then FilenameList.Add(String.Concat(fileParPath, "\.actors", "\<placeholder>.jpg"))
                            If forced OrElse (.MovieUseEden AndAlso .MovieActorThumbsEden) Then FilenameList.Add(String.Concat(fileParPath, "\.actors", "\<placeholder>.tbn"))
                            ...
                            End If
                        ElseIf isBDRip Then
                            If forced OrElse (.MovieUseFrodo AndAlso .MovieActorThumbsFrodo AndAlso Not .MovieXBMCProtectVTSBDMV) Then FilenameList.Add(String.Concat(Directory.GetParent(Directory.GetParent(fPath).FullName).FullName, "\.actors", "\<placeholder>.jpg"))
                            If forced OrElse (.MovieUseEden AndAlso .MovieActorThumbsEden) Then FilenameList.Add(String.Concat(Directory.GetParent(Directory.GetParent(fPath).FullName).FullName, "\.actors", "\<placeholder>.tbn"))
                        ...
                        ElseIf isSingle Then
                            If forced OrElse (.MovieUseFrodo AndAlso .MovieActorThumbsFrodo) Then FilenameList.Add(String.Concat(fileParPath, "\.actors", "\<placeholder>.jpg"))
                            If forced OrElse (.MovieUseEden AndAlso .MovieActorThumbsEden) Then FilenameList.Add(String.Concat(fileParPath, "\.actors", "\<placeholder>.tbn"))
                ...
                Case Enums.ModifierType.MainBanner
                    With Master.eSettings
                        If isVideoTS Then
                            If forced OrElse (.MovieUseExtended AndAlso .MovieBannerExtended) Then FilenameList.Add(Path.Combine(basePath, "banner.jpg"))
                            If forced OrElse (.MovieUseAD AndAlso .MovieBannerAD) Then FilenameList.Add(Path.Combine(basePath, "banner.jpg"))
                            If forced OrElse (.MovieUseNMJ AndAlso .MovieBannerNMJ) Then FilenameList.Add(String.Concat(Path.Combine(Directory.GetParent(Directory.GetParent(fileParPath).FullName).FullName, Directory.GetParent(fileParPath).Name), ".banner.jpg"))
                            If forced OrElse (.MovieUseYAMJ AndAlso .MovieBannerYAMJ) Then FilenameList.Add(String.Concat(Path.Combine(Directory.GetParent(fileParPath).FullName, Directory.GetParent(fileParPath).Name), ".banner.jpg"))
                        ...
                        ElseIf isBDRip Then
                            If forced OrElse (.MovieUseExtended AndAlso .MovieBannerExtended) Then FilenameList.Add(Path.Combine(basePath, "banner.jpg"))
                            If forced OrElse (.MovieUseAD AndAlso .MovieBannerAD) Then FilenameList.Add(Path.Combine(basePath, "banner.jpg"))
                            If forced OrElse (.MovieUseNMJ AndAlso .MovieBannerNMJ) Then FilenameList.Add(String.Concat(Path.Combine(Directory.GetParent(Directory.GetParent(Directory.GetParent(fileParPath).FullName).FullName).FullName, Directory.GetParent(Directory.GetParent(fileParPath).FullName).Name), ".banner.jpg"))
                            If forced OrElse (.MovieUseYAMJ AndAlso .MovieBannerYAMJ) Then FilenameList.Add(String.Concat(Path.Combine(Directory.GetParent(Directory.GetParent(fileParPath).FullName).FullName, Directory.GetParent(Directory.GetParent(fileParPath).FullName).Name), ".banner.jpg"))
                            ...
                            End If
                        ElseIf isSingle Then
                            If forced OrElse (.MovieUseExtended AndAlso isVideoTSFile AndAlso .MovieBannerExtended) Then FilenameList.Add(Path.Combine(fileParPath, "banner.jpg"))
                            If forced OrElse (.MovieUseExtended AndAlso Not isVideoTSFile AndAlso .MovieBannerExtended) Then FilenameList.Add(String.Concat(filePathStack, "-banner.jpg"))
                            If forced OrElse (.MovieUseAD AndAlso .MovieBannerAD) Then FilenameList.Add(Path.Combine(fileParPath, "banner.jpg"))
                            If forced OrElse (.MovieUseNMJ AndAlso .MovieBannerNMJ) Then FilenameList.Add(String.Concat(filePathStack, ".banner.jpg"))
                            If forced OrElse (.MovieUseYAMJ AndAlso .MovieBannerYAMJ) Then FilenameList.Add(String.Concat(filePath, ".banner.jpg"))
                            ...
                            End If
                        Else
                            If forced OrElse (.MovieUseExtended AndAlso .MovieBannerExtended) Then FilenameList.Add(String.Concat(filePathStack, "-banner.jpg"))
                            If forced OrElse (.MovieUseNMJ AndAlso .MovieBannerNMJ) Then FilenameList.Add(String.Concat(filePathStack, ".banner.jpg"))
                            If forced OrElse (.MovieUseYAMJ AndAlso .MovieBannerYAMJ) Then FilenameList.Add(String.Concat(filePath, ".banner.jpg"))
                ...
                Case Enums.ModifierType.MainClearArt
                    With Master.eSettings
                        If isVideoTS Then
                            If forced OrElse (.MovieUseExtended AndAlso .MovieClearArtExtended) Then FilenameList.Add(Path.Combine(basePath, "clearart.png"))
                            If forced OrElse (.MovieUseAD AndAlso .MovieClearArtAD) Then FilenameList.Add(Path.Combine(basePath, "clearart.png"))
                        ...
                        ElseIf isBDRip Then
                            ...
                            End If
                        ElseIf isSingle Then
                            If forced OrElse (.MovieUseExtended AndAlso isVideoTSFile AndAlso .MovieClearArtExtended) Then FilenameList.Add(Path.Combine(fileParPath, "clearart.png"))
                            If forced OrElse (.MovieUseExtended AndAlso Not isVideoTSFile AndAlso .MovieClearArtExtended) Then FilenameList.Add(String.Concat(filePathStack, "-clearart.png"))
                            If forced OrElse (.MovieUseAD AndAlso .MovieClearArtAD) Then FilenameList.Add(Path.Combine(fileParPath, "clearart.png"))
                            If .MovieUseExpert AndAlso isVideoTSFile AndAlso .MovieRecognizeVTSExpertVTS Then
                                For Each a In .MovieClearArtExpertVTS.Split(New String() {","c}, StringSplitOptions.RemoveEmptyEntries)
                                    FilenameList.Add(Path.Combine(fileParPath, a.Replace("<filename>", fileName)))
                                Next
                            ...
                            End If
                        Else
                            If forced OrElse (.MovieUseExtended AndAlso .MovieClearArtExtended) Then FilenameList.Add(String.Concat(filePathStack, "-clearart.png"))
                ...
                Case Enums.ModifierType.MainClearLogo
                    With Master.eSettings
                        If isVideoTS Then
                            If forced OrElse (.MovieUseExtended AndAlso .MovieClearLogoExtended) Then FilenameList.Add(Path.Combine(basePath, "clearlogo.png"))
                            If forced OrElse (.MovieUseAD AndAlso .MovieClearLogoAD) Then FilenameList.Add(Path.Combine(basePath, "logo.png"))
                        ...
                        ElseIf isBDRip Then
                            ...
                            End If
                        ElseIf isSingle Then
                            If forced OrElse (.MovieUseExtended AndAlso isVideoTSFile AndAlso .MovieClearLogoExtended) Then FilenameList.Add(Path.Combine(fileParPath, "clearlogo.png"))
                            If forced OrElse (.MovieUseExtended AndAlso Not isVideoTSFile AndAlso .MovieClearLogoExtended) Then FilenameList.Add(String.Concat(filePathStack, "-clearlogo.png"))
                            If forced OrElse (.MovieUseAD AndAlso .MovieClearLogoAD) Then FilenameList.Add(Path.Combine(fileParPath, "logo.png"))
                            If .MovieUseExpert AndAlso isVideoTSFile AndAlso .MovieRecognizeVTSExpertVTS Then
                                For Each a In .MovieClearLogoExpertVTS.Split(New String() {","c}, StringSplitOptions.RemoveEmptyEntries)
                                    FilenameList.Add(Path.Combine(fileParPath, a.Replace("<filename>", fileName)))
                                Next
                            ...
                            End If
                        Else
                            If forced OrElse (.MovieUseExtended AndAlso .MovieClearLogoExtended) Then FilenameList.Add(String.Concat(filePathStack, "-clearlogo.png"))
                ...
                Case Enums.ModifierType.MainDiscArt
                    With Master.eSettings
                        If isVideoTS Then
                            If forced OrElse (.MovieUseExtended AndAlso .MovieDiscArtExtended) Then FilenameList.Add(Path.Combine(basePath, "discart.png"))
                            If forced OrElse (.MovieUseAD AndAlso .MovieDiscArtAD) Then FilenameList.Add(Path.Combine(basePath, "disc.png"))
                        ...
                        ElseIf isBDRip Then
                            ...
                            End If
                        ElseIf isSingle Then
                            If forced OrElse (.MovieUseExtended AndAlso isVideoTSFile AndAlso .MovieDiscArtExtended) Then FilenameList.Add(Path.Combine(fileParPath, "discart.png"))
                            If forced OrElse (.MovieUseExtended AndAlso Not isVideoTSFile AndAlso .MovieDiscArtExtended) Then FilenameList.Add(String.Concat(filePathStack, "-discart.png"))
                            If forced OrElse (.MovieUseAD AndAlso .MovieDiscArtAD) Then FilenameList.Add(Path.Combine(fileParPath, "disc.png"))
                            If .MovieUseExpert AndAlso isVideoTSFile AndAlso .MovieRecognizeVTSExpertVTS Then
                                For Each a In .MovieDiscArtExpertVTS.Split(New String() {","c}, StringSplitOptions.RemoveEmptyEntries)
                                    FilenameList.Add(Path.Combine(fileParPath, a.Replace("<filename>", fileName)))
                                Next
                            ...
                            End If
                        Else
                            If forced OrElse (.MovieUseExtended AndAlso .MovieDiscArtExtended) Then FilenameList.Add(String.Concat(filePathStack, "-discart.png"))
                ...
                Case Enums.ModifierType.MainExtrafanarts
                    With Master.eSettings
                        If isVideoTS Then
                            If forced OrElse (.MovieUseFrodo AndAlso .MovieExtrafanartsFrodo AndAlso Not .MovieXBMCProtectVTSBDMV) Then FilenameList.Add(Path.Combine(Directory.GetParent(fPath).FullName, "extrafanart"))
                            If forced OrElse (.MovieUseEden AndAlso .MovieExtrafanartsEden) Then FilenameList.Add(Path.Combine(Directory.GetParent(fPath).FullName, "extrafanart"))
                            ...
                            End If
                        ElseIf isBDRip Then
                            If forced OrElse (.MovieUseFrodo AndAlso .MovieExtrafanartsFrodo AndAlso Not .MovieXBMCProtectVTSBDMV) Then FilenameList.Add(Path.Combine(Directory.GetParent(Directory.GetParent(fPath).FullName).FullName, "extrafanart"))
                            If forced OrElse (.MovieUseEden AndAlso .MovieExtrafanartsEden) Then FilenameList.Add(Path.Combine(Directory.GetParent(Directory.GetParent(fPath).FullName).FullName, "extrafanart"))
                            ...
                            End If
                        ElseIf isSingle Then
                            If forced OrElse (.MovieUseFrodo AndAlso .MovieExtrafanartsFrodo) Then FilenameList.Add(Path.Combine(fileParPath, "extrafanart"))
                            If forced OrElse (.MovieUseEden AndAlso .MovieExtrafanartsEden) Then FilenameList.Add(Path.Combine(fileParPath, "extrafanart"))
                ...
                Case Enums.ModifierType.MainExtrathumbs
                    With Master.eSettings
                        If isVideoTS Then
                            If forced OrElse (.MovieUseFrodo AndAlso .MovieExtrathumbsFrodo) AndAlso Not .MovieXBMCProtectVTSBDMV Then FilenameList.Add(Path.Combine(Directory.GetParent(fPath).FullName, "extrathumbs"))
                            If forced OrElse (.MovieUseEden AndAlso .MovieExtrathumbsEden) Then FilenameList.Add(Path.Combine(Directory.GetParent(fPath).FullName, "extrathumbs"))
                            ...
                            End If
                        ElseIf isBDRip Then
                            If forced OrElse (.MovieUseFrodo AndAlso .MovieExtrathumbsFrodo AndAlso Not .MovieXBMCProtectVTSBDMV) Then FilenameList.Add(Path.Combine(Directory.GetParent(Directory.GetParent(fPath).FullName).FullName, "extrathumbs"))
                            If forced OrElse (.MovieUseEden AndAlso .MovieExtrathumbsEden) Then FilenameList.Add(Path.Combine(Directory.GetParent(Directory.GetParent(fPath).FullName).FullName, "extrathumbs"))
                            ...
                            End If
                        ElseIf isSingle Then
                            If forced OrElse (.MovieUseFrodo AndAlso .MovieExtrathumbsFrodo) Then FilenameList.Add(Path.Combine(fileParPath, "extrathumbs"))
                            If forced OrElse (.MovieUseEden AndAlso .MovieExtrathumbsEden) Then FilenameList.Add(Path.Combine(fileParPath, "extrathumbs"))
                ...
                Case Enums.ModifierType.MainFanart
                    With Master.eSettings
                        If isVideoTS Then
                            If forced OrElse (.MovieUseFrodo AndAlso .MovieFanartFrodo) Then FilenameList.Add(Path.Combine(basePath, "fanart.jpg"))
                            If forced OrElse (.MovieUseBoxee AndAlso .MovieFanartBoxee) Then FilenameList.Add(Path.Combine(basePath, "fanart.jpg"))
                            If forced OrElse (.MovieUseEden AndAlso .MovieFanartEden) Then FilenameList.Add(String.Concat(filePath, "-fanart.jpg"))
                            If forced OrElse (.MovieUseNMJ AndAlso .MovieFanartNMJ) Then FilenameList.Add(String.Concat(Path.Combine(Directory.GetParent(Directory.GetParent(fileParPath).FullName).FullName, Directory.GetParent(fileParPath).Name), ".fanart.jpg"))
                            If forced OrElse (.MovieUseYAMJ AndAlso .MovieFanartYAMJ) Then FilenameList.Add(String.Concat(Path.Combine(Directory.GetParent(fileParPath).FullName, Directory.GetParent(fileParPath).Name), ".fanart.jpg"))
                        ...
                        ElseIf isBDRip Then
                            If forced OrElse (.MovieUseFrodo AndAlso .MovieFanartFrodo) Then FilenameList.Add(Path.Combine(basePath, "fanart.jpg"))
                            If forced OrElse (.MovieUseEden AndAlso .MovieFanartEden) Then FilenameList.Add(Path.Combine(Directory.GetParent(fileParPath).FullName, "index-fanart.jpg"))
                            If forced OrElse (.MovieUseNMJ AndAlso .MovieFanartNMJ) Then FilenameList.Add(String.Concat(Path.Combine(Directory.GetParent(Directory.GetParent(Directory.GetParent(fileParPath).FullName).FullName).FullName, Directory.GetParent(Directory.GetParent(fileParPath).FullName).Name), ".fanart.jpg"))
                            If forced OrElse (.MovieUseYAMJ AndAlso .MovieFanartYAMJ) Then FilenameList.Add(String.Concat(Path.Combine(Directory.GetParent(Directory.GetParent(fileParPath).FullName).FullName, Directory.GetParent(Directory.GetParent(fileParPath).FullName).Name), ".fanart.jpg"))
                            ...
                            End If
                        ElseIf isSingle Then
                            If forced OrElse (.MovieUseFrodo AndAlso isVideoTSFile AndAlso .MovieFanartFrodo) Then FilenameList.Add(Path.Combine(fileParPath, "fanart.jpg"))
                            If forced OrElse (.MovieUseFrodo AndAlso Not isVideoTSFile AndAlso .MovieFanartFrodo) Then FilenameList.Add(String.Concat(filePathStack, "-fanart.jpg"))
                            If forced OrElse (.MovieUseBoxee AndAlso .MovieFanartBoxee) Then FilenameList.Add(Path.Combine(fileParPath, "fanart.jpg"))
                            If forced OrElse (.MovieUseEden AndAlso .MovieFanartEden) Then FilenameList.Add(String.Concat(filePath, "-fanart.jpg"))
                            If forced OrElse (.MovieUseNMJ AndAlso .MovieFanartNMJ) Then FilenameList.Add(String.Concat(filePathStack, ".fanart.jpg"))
                            If forced OrElse (.MovieUseYAMJ AndAlso .MovieFanartYAMJ) Then FilenameList.Add(String.Concat(filePath, ".fanart.jpg"))
                            If .MovieUseExpert AndAlso isVideoTSFile AndAlso .MovieRecognizeVTSExpertVTS Then
                                For Each a In .MovieFanartExpertVTS.Split(New String() {","c}, StringSplitOptions.RemoveEmptyEntries)
                                    FilenameList.Add(Path.Combine(fileParPath, a.Replace("<filename>", fileName)))
                                Next
                            ...
                            End If
                        Else
                            If forced OrElse (.MovieUseFrodo AndAlso .MovieFanartFrodo) Then FilenameList.Add(String.Concat(filePathStack, "-fanart.jpg"))
                            If forced OrElse (.MovieUseEden AndAlso .MovieFanartEden) Then FilenameList.Add(String.Concat(filePath, "-fanart.jpg"))
                            If forced OrElse (.MovieUseNMJ AndAlso .MovieFanartNMJ) Then FilenameList.Add(String.Concat(filePathStack, ".fanart.jpg"))
                            If forced OrElse (.MovieUseYAMJ AndAlso .MovieFanartYAMJ) Then FilenameList.Add(String.Concat(filePath, ".fanart.jpg"))
                ...
                Case Enums.ModifierType.MainKeyart
                    With Master.eSettings
                        If isVideoTS Then
                            If forced OrElse (.MovieUseExtended AndAlso .MovieKeyartExtended) Then FilenameList.Add(Path.Combine(basePath, "keyart.jpg"))
                        ...
                        ElseIf isBDRip Then
                            ...
                            End If
                        ElseIf isSingle Then
                            If forced OrElse (.MovieUseExtended AndAlso isVideoTSFile AndAlso .MovieKeyartExtended) Then FilenameList.Add(Path.Combine(fileParPath, "keyart.jpg"))
                            If forced OrElse (.MovieUseExtended AndAlso Not isVideoTSFile AndAlso .MovieKeyartExtended) Then FilenameList.Add(String.Concat(filePathStack, "-keyart.jpg"))
                            If .MovieUseExpert AndAlso isVideoTSFile AndAlso .MovieRecognizeVTSExpertVTS Then
                                For Each a In .MovieKeyartExpertVTS.Split(New String() {","c}, StringSplitOptions.RemoveEmptyEntries)
                                    FilenameList.Add(Path.Combine(fileParPath, a.Replace("<filename>", fileName)))
                                Next
                            ...
                            End If
                        Else
                            If forced OrElse (.MovieUseExtended AndAlso .MovieKeyartExtended) Then FilenameList.Add(String.Concat(filePathStack, "-keyart.jpg"))
                ...
                Case Enums.ModifierType.MainLandscape
                    With Master.eSettings
                        If isVideoTS Then
                            If forced OrElse (.MovieUseExtended AndAlso .MovieLandscapeExtended) Then FilenameList.Add(Path.Combine(basePath, "landscape.jpg"))
                            If forced OrElse (.MovieUseAD AndAlso .MovieLandscapeAD) Then FilenameList.Add(Path.Combine(basePath, "landscape.jpg"))
                        ...
                        ElseIf isBDRip Then
                            ...
                            End If
                        ElseIf isSingle Then
                            If forced OrElse (.MovieUseExtended AndAlso isVideoTSFile AndAlso .MovieLandscapeExtended) Then FilenameList.Add(Path.Combine(fileParPath, "landscape.jpg"))
                            If forced OrElse (.MovieUseExtended AndAlso Not isVideoTSFile AndAlso .MovieLandscapeExtended) Then FilenameList.Add(String.Concat(filePathStack, "-landscape.jpg"))
                            If forced OrElse (.MovieUseAD AndAlso isVideoTSFile AndAlso .MovieLandscapeAD) Then FilenameList.Add(Path.Combine(fileParPath, "landscape.jpg"))
                            If forced OrElse (.MovieUseAD AndAlso Not isVideoTSFile AndAlso .MovieLandscapeAD) Then FilenameList.Add(Path.Combine(fileParPath, "landscape.jpg"))
                            If .MovieUseExpert AndAlso isVideoTSFile AndAlso .MovieRecognizeVTSExpertVTS Then
                                For Each a In .MovieLandscapeExpertVTS.Split(New String() {","c}, StringSplitOptions.RemoveEmptyEntries)
                                    FilenameList.Add(Path.Combine(fileParPath, a.Replace("<filename>", fileName)))
                                Next
                            ...
                            End If
                        Else
                            If forced OrElse (.MovieUseExtended AndAlso .MovieLandscapeExtended) Then FilenameList.Add(String.Concat(filePathStack, "-landscape.jpg"))
                ...
                Case Enums.ModifierType.MainNFO
                    With Master.eSettings
                        If isVideoTS Then
                            If forced OrElse (.MovieUseFrodo AndAlso .MovieNFOFrodo AndAlso .MovieXBMCProtectVTSBDMV) Then FilenameList.Add(Path.Combine(basePath, "movie.nfo"))
                            If forced OrElse (.MovieUseFrodo AndAlso .MovieNFOFrodo AndAlso Not .MovieXBMCProtectVTSBDMV) Then FilenameList.Add(String.Concat(filePath, ".nfo"))
                            If forced OrElse (.MovieUseBoxee AndAlso .MovieNFOBoxee) Then FilenameList.Add(String.Concat(filePath, ".nfo"))
                            If forced OrElse (.MovieUseEden AndAlso .MovieNFOEden) Then FilenameList.Add(String.Concat(filePath, ".nfo"))
                            If forced OrElse (.MovieUseNMJ AndAlso .MovieNFONMJ) Then FilenameList.Add(String.Concat(Directory.GetParent(fileParPath).FullName, Path.DirectorySeparatorChar, Directory.GetParent(fileParPath).Name, ".nfo"))
                            If forced OrElse (.MovieUseYAMJ AndAlso .MovieNFOYAMJ) Then FilenameList.Add(String.Concat(Directory.GetParent(fileParPath).FullName, Path.DirectorySeparatorChar, Directory.GetParent(fileParPath).Name, ".nfo"))
                        ...
                        ElseIf isBDRip Then
                            If forced OrElse (.MovieUseFrodo AndAlso .MovieNFOFrodo AndAlso .MovieXBMCProtectVTSBDMV) Then FilenameList.Add(Path.Combine(basePath, "movie.nfo"))
                            If forced OrElse (.MovieUseFrodo AndAlso .MovieNFOFrodo AndAlso Not .MovieXBMCProtectVTSBDMV) Then FilenameList.Add(Path.Combine(Directory.GetParent(fileParPath).FullName, "index.nfo"))
                            If forced OrElse (.MovieUseEden AndAlso .MovieNFOEden) Then FilenameList.Add(Path.Combine(Directory.GetParent(fileParPath).FullName, "index.nfo"))
                            If forced OrElse (.MovieUseNMJ AndAlso .MovieNFONMJ) Then FilenameList.Add(String.Concat(Directory.GetParent(Directory.GetParent(Directory.GetParent(fileParPath).FullName).FullName).FullName, Path.DirectorySeparatorChar, Directory.GetParent(Directory.GetParent(fileParPath).FullName).Name, ".nfo"))
                            If forced OrElse (.MovieUseYAMJ AndAlso .MovieNFOYAMJ) Then FilenameList.Add(String.Concat(Directory.GetParent(Directory.GetParent(fileParPath).FullName).FullName, Path.DirectorySeparatorChar, Directory.GetParent(Directory.GetParent(fileParPath).FullName).Name, ".nfo"))
                            ...
                            End If
                        ElseIf isSingle Then
                            If forced OrElse (.MovieUseFrodo AndAlso .MovieNFOFrodo AndAlso isVideoTSFile) Then FilenameList.Add(String.Concat(filePath, ".nfo"))
                            If forced OrElse (.MovieUseFrodo AndAlso .MovieNFOFrodo AndAlso Not isVideoTSFile) Then FilenameList.Add(String.Concat(filePathStack, ".nfo"))
                            If forced OrElse (.MovieUseBoxee AndAlso .MovieNFOBoxee AndAlso isVideoTSFile) Then FilenameList.Add(String.Concat(filePath, ".nfo"))
                            If forced OrElse (.MovieUseBoxee AndAlso .MovieNFOBoxee AndAlso Not isVideoTSFile) Then FilenameList.Add(Path.Combine(fileParPath, "movie.nfo"))
                            If forced OrElse (.MovieUseEden AndAlso .MovieNFOEden) Then FilenameList.Add(String.Concat(filePath, ".nfo"))
                            If forced OrElse (.MovieUseNMJ AndAlso .MovieNFONMJ) Then FilenameList.Add(String.Concat(filePath, ".nfo"))
                            If forced OrElse (.MovieUseYAMJ AndAlso .MovieNFOYAMJ) Then FilenameList.Add(String.Concat(filePath, ".nfo"))
                            If .MovieUseExpert AndAlso isVideoTSFile AndAlso .MovieRecognizeVTSExpertVTS Then
                            ...
                            End If
                        Else
                            If forced OrElse (.MovieUseFrodo AndAlso .MovieNFOFrodo) Then FilenameList.Add(String.Concat(filePathStack, ".nfo"))
                            If forced OrElse (.MovieUseEden AndAlso .MovieNFOEden) Then FilenameList.Add(String.Concat(filePath, ".nfo"))
                            If forced OrElse (.MovieUseNMJ AndAlso .MovieNFONMJ) Then FilenameList.Add(String.Concat(filePath, ".nfo"))
                            If forced OrElse (.MovieUseYAMJ AndAlso .MovieNFOYAMJ) Then FilenameList.Add(String.Concat(filePath, ".nfo"))
                ...
                Case Enums.ModifierType.MainPoster
                    With Master.eSettings
                        If isVideoTS Then
                            If forced OrElse (.MovieUseFrodo AndAlso .MoviePosterFrodo) Then FilenameList.Add(Path.Combine(basePath, "poster.jpg"))
                            If forced OrElse (.MovieUseBoxee AndAlso .MoviePosterBoxee) Then FilenameList.Add(Path.Combine(basePath, "folder.jpg"))
                            If forced OrElse (.MovieUseEden AndAlso .MoviePosterEden) Then FilenameList.Add(String.Concat(filePath, ".tbn"))
                            If forced OrElse (.MovieUseNMJ AndAlso .MoviePosterNMJ) Then FilenameList.Add(String.Concat(Path.Combine(Directory.GetParent(Directory.GetParent(fileParPath).FullName).FullName, Directory.GetParent(fileParPath).Name), ".jpg"))
                            If forced OrElse (.MovieUseYAMJ AndAlso .MoviePosterYAMJ) Then FilenameList.Add(String.Concat(Path.Combine(Directory.GetParent(fileParPath).FullName, Directory.GetParent(fileParPath).Name), ".jpg"))
                        ...
                        ElseIf isBDRip Then
                            If forced OrElse (.MovieUseFrodo AndAlso .MoviePosterFrodo) Then FilenameList.Add(Path.Combine(basePath, "poster.jpg"))
                            If forced OrElse (.MovieUseEden AndAlso .MoviePosterEden) Then FilenameList.Add(Path.Combine(Directory.GetParent(fileParPath).FullName, "index.tbn"))
                            If forced OrElse (.MovieUseNMJ AndAlso .MoviePosterNMJ) Then FilenameList.Add(String.Concat(Path.Combine(Directory.GetParent(Directory.GetParent(Directory.GetParent(fileParPath).FullName).FullName).FullName, Directory.GetParent(Directory.GetParent(fileParPath).FullName).Name), ".jpg"))
                            If forced OrElse (.MovieUseYAMJ AndAlso .MoviePosterYAMJ) Then FilenameList.Add(String.Concat(Path.Combine(Directory.GetParent(Directory.GetParent(fileParPath).FullName).FullName, Directory.GetParent(Directory.GetParent(fileParPath).FullName).Name), ".jpg"))
                            ...
                            End If
                        ElseIf isSingle Then
                            If forced OrElse (.MovieUseFrodo AndAlso isVideoTSFile AndAlso .MoviePosterFrodo) Then FilenameList.Add(Path.Combine(fileParPath, "poster.jpg"))
                            If forced OrElse (.MovieUseFrodo AndAlso Not isVideoTSFile AndAlso .MoviePosterFrodo) Then FilenameList.Add(String.Concat(filePathStack, "-poster.jpg"))
                            If forced OrElse (.MovieUseBoxee AndAlso .MoviePosterBoxee) Then FilenameList.Add(Path.Combine(fileParPath, "folder.jpg"))
                            If forced OrElse (.MovieUseEden AndAlso .MoviePosterEden) Then FilenameList.Add(String.Concat(filePath, ".tbn"))
                            If forced OrElse (.MovieUseNMJ AndAlso .MoviePosterNMJ) Then FilenameList.Add(String.Concat(filePathStack, ".jpg"))
                            If forced OrElse (.MovieUseYAMJ AndAlso .MoviePosterYAMJ) Then FilenameList.Add(String.Concat(filePath, ".jpg"))
                            If .MovieUseExpert AndAlso isVideoTSFile AndAlso .MovieRecognizeVTSExpertVTS Then
                                For Each a In .MoviePosterExpertVTS.Split(New String() {","c}, StringSplitOptions.RemoveEmptyEntries)
                                    FilenameList.Add(Path.Combine(fileParPath, a.Replace("<filename>", fileName)))
                                Next
                            ...
                            End If
                        Else
                            If forced OrElse (.MovieUseFrodo AndAlso .MovieFanartFrodo) Then FilenameList.Add(String.Concat(filePathStack, "-poster.jpg"))
                            If forced OrElse (.MovieUseBoxee AndAlso .MoviePosterBoxee) Then FilenameList.Add(Path.Combine(filePath, ".tbn"))
                            If forced OrElse (.MovieUseEden AndAlso .MovieFanartEden) Then FilenameList.Add(String.Concat(filePath, ".tbn"))
                            If forced OrElse (.MovieUseNMJ AndAlso .MovieFanartNMJ) Then FilenameList.Add(String.Concat(filePathStack, ".jpg"))
                            If forced OrElse (.MovieUseYAMJ AndAlso .MovieFanartYAMJ) Then FilenameList.Add(String.Concat(String.Concat(filePath, ".jpg")))
                ...
                Case Enums.ModifierType.MainTrailer
                    With Master.eSettings
                        If isVideoTS Then
                            If forced OrElse (.MovieUseFrodo AndAlso .MovieTrailerFrodo AndAlso Not .MovieXBMCProtectVTSBDMV) Then FilenameList.Add(String.Concat(filePath, "-trailer"))
                            If forced OrElse (.MovieUseEden AndAlso .MovieTrailerEden) Then FilenameList.Add(String.Concat(filePath, "-trailer"))
                            If forced OrElse (.MovieUseNMJ AndAlso .MovieTrailerNMJ) Then FilenameList.Add(String.Concat(basePath, Path.DirectorySeparatorChar, Directory.GetParent(fileParPath).Name, ".[trailer]"))
                            If forced OrElse (.MovieUseYAMJ AndAlso .MovieTrailerYAMJ) Then FilenameList.Add(String.Concat(basePath, Path.DirectorySeparatorChar, Directory.GetParent(fileParPath).Name, ".[trailer]"))
                            ...
                            End If
                        ElseIf isBDRip Then
                            If forced OrElse (.MovieUseFrodo AndAlso .MovieTrailerFrodo AndAlso Not .MovieXBMCProtectVTSBDMV) Then FilenameList.Add(String.Concat(Directory.GetParent(fileParPath).FullName, Path.DirectorySeparatorChar, "index-trailer"))
                            If forced OrElse (.MovieUseEden AndAlso .MovieTrailerEden) Then FilenameList.Add(String.Concat(Directory.GetParent(fileParPath).FullName, Path.DirectorySeparatorChar, "index-trailer"))
                            If forced OrElse (.MovieUseNMJ AndAlso .MovieTrailerNMJ) Then FilenameList.Add(String.Concat(basePath, Path.DirectorySeparatorChar, Directory.GetParent(Directory.GetParent(fileParPath).FullName).Name, ".[trailer]"))
                            If forced OrElse (.MovieUseYAMJ AndAlso .MovieTrailerYAMJ) Then FilenameList.Add(String.Concat(basePath, Path.DirectorySeparatorChar, Directory.GetParent(Directory.GetParent(fileParPath).FullName).Name, ".[trailer]"))
                            ...
                            End If
                        ElseIf isSingle Then
                            If forced OrElse (.MovieUseFrodo AndAlso .MovieTrailerFrodo) Then FilenameList.Add(String.Concat(filePathStack, "-trailer"))
                            If forced OrElse (.MovieUseEden AndAlso .MovieTrailerEden) Then FilenameList.Add(String.Concat(filePath, "-trailer"))
                            If forced OrElse (.MovieUseNMJ AndAlso .MovieTrailerNMJ) Then FilenameList.Add(String.Concat(filePath, ".[trailer]"))
                            If forced OrElse (.MovieUseYAMJ AndAlso .MovieTrailerYAMJ) Then FilenameList.Add(String.Concat(filePath, ".[trailer]"))
                            If .MovieUseExpert AndAlso isVideoTSFile AndAlso .MovieRecognizeVTSExpertVTS Then
                                For Each a In .MovieTrailerExpertVTS.Split(New String() {","c}, StringSplitOptions.RemoveEmptyEntries)
                                    FilenameList.Add(Path.Combine(fileParPath, a.Replace("<filename>", fileName)))
                                Next
        ...
        ''' <returns><c>List(Of String)</c> all filenames with full path</returns>
        ''' <remarks></remarks>
        Public Shared Function Movieset(ByVal dbMovieset As Database.DBElement, ByVal modifierType As Enums.ModifierType, Optional ByVal forceOldTitle As Boolean = False) As List(Of String)
            Dim FilenameList As New List(Of String)

            If String.IsNullOrEmpty(dbMovieset.MainDetails.Title) Then Return FilenameList

            Dim fSetTitle As String = If(forceOldTitle, dbMovieset.MainDetails.Title_Old, dbMovieset.MainDetails.Title)
        ...
        Public Shared Function TVEpisode(ByVal dbTVEpisode As Database.DBElement, ByVal modifierType As Enums.ModifierType) As List(Of String)
            Dim FilenameList As New List(Of String)

            If String.IsNullOrEmpty(dbTVEpisode.Filename) Then Return FilenameList

            Dim fEpisodeFileName As String = Path.GetFileNameWithoutExtension(dbTVEpisode.Filename)
            Dim fEpisodePath As String = Common.RemoveExtFromPath(dbTVEpisode.Filename)
            Dim fEpisodeParentPath As String = Directory.GetParent(dbTVEpisode.Filename).FullName
            Dim sSeason As String = dbTVEpisode.MainDetails.Season.ToString.PadLeft(2, Convert.ToChar("0"))
        ...
        Public Shared Function TVSeason(ByVal dbTVSeason As Database.DBElement, ByVal modifierType As Enums.ModifierType) As List(Of String)
            Dim FilenameList As New List(Of String)
            Dim bInside As Boolean = False

            If String.IsNullOrEmpty(dbTVSeason.ShowPath) Then Return FilenameList

            Dim fEpisodePath As String = String.Empty
            Dim fSeasonPath As String = Functions.GetSeasonDirectoryFromShowPath(dbTVSeason.ShowPath, dbTVSeason.MainDetails.Season)
            Dim fShowPath As String = dbTVSeason.ShowPath
            Dim sSeason As String = dbTVSeason.MainDetails.Season.ToString.PadLeft(2, Convert.ToChar("0"))
            ...
            Try
                If Master.eSettings.TVUseYAMJ AndAlso Not bInside Then
                    ...
                    Master.DB.FillDataTable_TVEpisode(dtEpisodes, String.Concat("SELECT * FROM episode INNER JOIN files ON (files.idFile = episode.idFile) WHERE idShow = ", dbTVSeason.ShowID, " AND Season = ", dbTVSeason.MainDetails.Season, " ORDER BY Episode;"))
            ...
            Select Case modifierType
                Case Enums.ModifierType.SeasonBanner
                    With Master.eSettings
                        If dbTVSeason.MainDetails.Season = 0 Then 'season specials
                            ...
                            If .TVUseExpert AndAlso Not String.IsNullOrEmpty(.TVSeasonBannerExpert) Then
                                For Each a In .TVSeasonBannerExpert.Split(New String() {","c}, StringSplitOptions.RemoveEmptyEntries)
                                    If Not (a.Contains("<seasonpath>") AndAlso Not bInside) Then
                                        ...
                                        sPath = String.Format(sPath, sSeason, dbTVSeason.MainDetails.Season, sSeason) 'Season# padding: {0} = 01; {1} = 1; {2} = 01
        ...
        Public Shared Function TVShow(ByVal dbTVShow As Database.DBElement, ByVal modifierType As Enums.ModifierType) As List(Of String)
            Dim FilenameList As New List(Of String)

            If String.IsNullOrEmpty(dbTVShow.ShowPath) Then Return FilenameList

            Dim fShowPath As String = dbTVShow.ShowPath
...
#Region "Nested Types"
        ...
        ''' <summary>
        ''' Replaces all invalid chars in a directory name with "_"
        ''' </summary>
        ''' <param name="directoryName"></param>
        ''' <returns></returns>
        Private Shared Function CleanDirectoryForKodi(ByVal directoryName As String) As String
            Dim invalidPathChars() As Char = Path.GetInvalidPathChars()
            For Each someChar In invalidPathChars
                directoryName = directoryName.Replace(someChar, "_")
            Next
        ...
        Public Sub SortFiles(ByVal sourcePath As String)
            ...
            Try
                If Directory.Exists(sourcePath) Then
                    ...
                    lstVideosInDir = diSourcePath.GetFiles.Where(Function(f) Master.eSettings.Options.FileSystem.ValidVideoExtensions.Contains(f.Extension.ToLower) AndAlso
                             Not Regex.IsMatch(f.Name, String.Concat("[^\w\s]\s?(", Master.eAdvancedSettings.GetStringSetting("NotValidFileContains", "trailer|sample"), ")"), RegexOptions.IgnoreCase) AndAlso
                    ...
                    For Each sFile As FileInfo In lstVideosInDir
                        ...
                        For Each a In FileNames.Movie(nMovie, Enums.ModifierType.MainBanner, True)
                            If File.Exists(a) Then File.Move(a, Path.Combine(strNewPath, Path.GetFileName(a)))
                        Next
                        For Each a In FileNames.Movie(nMovie, Enums.ModifierType.MainCharacterArt, True)
                            If File.Exists(a) Then File.Move(a, Path.Combine(strNewPath, Path.GetFileName(a)))
                        Next
                        For Each a In FileNames.Movie(nMovie, Enums.ModifierType.MainClearArt, True)
                            If File.Exists(a) Then File.Move(a, Path.Combine(strNewPath, Path.GetFileName(a)))
                        Next
                        For Each a In FileNames.Movie(nMovie, Enums.ModifierType.MainClearLogo, True)
                            If File.Exists(a) Then File.Move(a, Path.Combine(strNewPath, Path.GetFileName(a)))
                        Next
                        For Each a In FileNames.Movie(nMovie, Enums.ModifierType.MainDiscArt, True)
                            If File.Exists(a) Then File.Move(a, Path.Combine(strNewPath, Path.GetFileName(a)))
                        Next
                        For Each a In FileNames.Movie(nMovie, Enums.ModifierType.MainFanart, True)
                            If File.Exists(a) Then File.Move(a, Path.Combine(strNewPath, Path.GetFileName(a)))
                        Next
                        For Each a In FileNames.Movie(nMovie, Enums.ModifierType.MainLandscape, True)
                            If File.Exists(a) Then File.Move(a, Path.Combine(strNewPath, Path.GetFileName(a)))
                        Next
                        For Each a In FileNames.Movie(nMovie, Enums.ModifierType.MainNFO, True)
                            If File.Exists(a) Then File.Move(a, Path.Combine(strNewPath, Path.GetFileName(a)))
                        Next
                        For Each a In FileNames.Movie(nMovie, Enums.ModifierType.MainPoster, True)
                            If File.Exists(a) Then File.Move(a, Path.Combine(strNewPath, Path.GetFileName(a)))
                        Next
                        For Each a In FileNames.Movie(nMovie, Enums.ModifierType.MainTheme, True)
                            ...
                            Next
                        Next
                        For Each a In FileNames.Movie(nMovie, Enums.ModifierType.MainTrailer, True)
