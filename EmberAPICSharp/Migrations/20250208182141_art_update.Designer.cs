...
namespace EmberAPICSharp.Migrations
{
    ...
    [Migration("20250208182141_art_update")]
    partial class art_update
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EmberAPI.EFModels.StudioLink", b =>
                {
                    ...
                    b.HasIndex(new[] { "Id", "MediaType", "IdMedia" }, "ix_studio_link_1")
                        .IsUnique();

                    b.HasIndex(new[] { "IdMedia", "MediaType", "Id" }, "ix_studio_link_2")
                        .IsUnique();
            ...
            modelBuilder.Entity("EmberAPI.EFModels.TagLink", b =>
                {
                    ...
                    b.HasIndex(new[] { "Id", "MediaType", "IdMedia" }, "ix_taglinks_1")
                        .IsUnique();

                    b.HasIndex(new[] { "IdMedia", "MediaType", "Id" }, "ix_taglinks_2")
                        .IsUnique();
